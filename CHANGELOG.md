...
## [4.0.0](https://github.com/q0wqex/zashboard/compare/v3.4.0...v4.0.0) (2026-04-13)
...
* adaptation for sing-box ui upgrade API ([8f35a14](https://github.com/q0wqex/zashboard/commit/8f35a14189057d693c66d0c575e95db0d3d52722))
* adaptive modal height for proxy group mobile ([7a5db3d](https://github.com/q0wqex/zashboard/commit/7a5db3d2d42c8c1c8086c499512ba2bf2dff8947))
* add `light-monet` and `dark-monet` accent color themes provided by ksu webui when running in ksu app ([#592](https://github.com/q0wqex/zashboard/issues/592)) ([69c276b](https://github.com/q0wqex/zashboard/commit/69c276b36af024c9bebc877f46600162e6884224))
* add Apple-style themes and refine UI to macOS/iOS aesthetic ([f75144a](https://github.com/q0wqex/zashboard/commit/f75144addf8072b049798f9aef463aa61537c6cc))
* add auto cleanup interval feature to ConnectionHistory component with multilingual support ([1d358bd](https://github.com/q0wqex/zashboard/commit/1d358bdb775a1129e5635400eaf34b32137ca3e5))
* add backend selection dialog to sidebar ([9b31df2](https://github.com/q0wqex/zashboard/commit/9b31df2e78d12f47900304f88b80fd4602732440))
* add custom theme ([4679ddd](https://github.com/q0wqex/zashboard/commit/4679dddb900271386e430e7bc691bbf06fb44180))
* add dark mode favicon and update asset inclusion in Vite configuration ([50a66c3](https://github.com/q0wqex/zashboard/commit/50a66c3f478cf50942ba1d40751fa38e09fd8353))
* add full-screen toggle functionality to TopologyCharts component with responsive chart rendering ([565ea7e](https://github.com/q0wqex/zashboard/commit/565ea7edb66bb4958d18a5d3c03014e293cc06be))
* add gh-pages-cdn-fonts branch ([899c1d0](https://github.com/q0wqex/zashboard/commit/899c1d0a1e0af4ab807e90724c8cea7c434cfba1))
* add GitHub Actions workflow for automated releases, multi-variant deployments, and container image publishing ([ce75f2a](https://github.com/q0wqex/zashboard/commit/ce75f2a5195386dfd750cb2682bc43ef6499e4df))
* add level filter options for logs ([6f5c9dc](https://github.com/q0wqex/zashboard/commit/6f5c9dcf5fe4d44ac8c57880fdb684b27eb667cd))
* add log filtering functionality with regex support ([1b4c56b](https://github.com/q0wqex/zashboard/commit/1b4c56b5ee03414b5bd4a595f11992c00d24b772))
* add manual block(degrade) btn for conn which belongs to smart group ([#502](https://github.com/q0wqex/zashboard/issues/502)) ([1a9c12b](https://github.com/q0wqex/zashboard/commit/1a9c12b9b40979f480707d227ea588f58a484552))
* add more settings button and improve layout in sidebar components ([73de34f](https://github.com/q0wqex/zashboard/commit/73de34f00d1abf242766ea8eacb90640d29445ae))
* add network info switch for overview page ([bc5403d](https://github.com/q0wqex/zashboard/commit/bc5403da40134b0d6800806321930e7e62dfb955))
* add provider traffic overview localization and integrate component into OverviewPage ([5c432c0](https://github.com/q0wqex/zashboard/commit/5c432c0a4b1847a93e36cca56f6dfb06b6271711))
* add quick filter toggle for connection visibility in ctrl with tooltip updates ([02e4441](https://github.com/q0wqex/zashboard/commit/02e4441504d1cb1a19bb90bd1b9f5ff1e2844562))
* add reset settings functionality with confirmation dialog ([63aab08](https://github.com/q0wqex/zashboard/commit/63aab08a8d6628c8e6b89d4531e582e241723a0d))
* add RuleHitCountCard component and update related translations for enhanced statistics display ([372cd67](https://github.com/q0wqex/zashboard/commit/372cd67450d4dafe913daad94d33c3ff946028c3))
* add scroll-to-group button in ProxyGroupNow ([b148917](https://github.com/q0wqex/zashboard/commit/b148917518a9931e56a974a05cc9555a1bc5a44f))
* add styles to the controls in a style similar to the new Apple design ([11aa106](https://github.com/q0wqex/zashboard/commit/11aa10611c29413668454074390cae0486d8f3b9))
* add styles to the dock in a style similar to the new Apple design ([9680744](https://github.com/q0wqex/zashboard/commit/9680744d11e8558815fb66fc3d879af631b6b906))
* add toast for backend API call ([07833ba](https://github.com/q0wqex/zashboard/commit/07833ba696865c9e54cce655a383a94da58e7ec0))
* add toggle for full proxy chain display and update related components for improved user experience ([a378cc1](https://github.com/q0wqex/zashboard/commit/a378cc1255413f6eb76b1c53603d07a240bfd01b))
* add toggle functionality for rule disabling in RuleCard component and update API integration ([6e4512d](https://github.com/q0wqex/zashboard/commit/6e4512dd69dc013701eabfff38a059bca4c3799f))
* add Traditional Chinese localization support in zh-tw.ts ([5e837d1](https://github.com/q0wqex/zashboard/commit/5e837d1a55e24fb4b1635fcf2382e0be29197201))
* add two-column layout for settings page on wide screens ([85d675b](https://github.com/q0wqex/zashboard/commit/85d675b215afd368a9ef5a733c8076a63a2ce376))
* add update configs functionality via path or payload ([4308a92](https://github.com/q0wqex/zashboard/commit/4308a92a1cdfaa7711c36c0c00f2eaeff43d38db))
* adjust smart rank display ([#520](https://github.com/q0wqex/zashboard/issues/520)) ([7e2b125](https://github.com/q0wqex/zashboard/commit/7e2b125d77897b47e691fda4e1a1830967f7750a))
* allow setting separate test URLs for each group ([a7ef57a](https://github.com/q0wqex/zashboard/commit/a7ef57a0ff5e466ab4f4177948dc2f57f5b93c58))
* allow user input for DNS query type ([e230304](https://github.com/q0wqex/zashboard/commit/e230304a5b56dd0fb5a72f6a7849f774134b2290))
* auto disconnect idle udp ([7943d73](https://github.com/q0wqex/zashboard/commit/7943d7304b0716daf687d605cb58ca58a00c92ce))
* auto scroll into view for proxy node ([3064505](https://github.com/q0wqex/zashboard/commit/30645058f639dbe01cf07654b1460c73db905129))
* auto switch to url backend if exist ([1315204](https://github.com/q0wqex/zashboard/commit/1315204385835c3367415f55db0d636b6a940415))
* autocomplete for source ip label ([83640ca](https://github.com/q0wqex/zashboard/commit/83640ca5e0a334a86202cc379042fb9c72ac6254))
* available proxy count ([163f261](https://github.com/q0wqex/zashboard/commit/163f261d71d0704d2c44e601530b02af560698b5))
* **backend:** add disableTunMode property and update related logic ([356f1cb](https://github.com/q0wqex/zashboard/commit/356f1cba577c449cc4edbd252feec4c698f77bca))
* **backend:** add success notification for flushing smart weights ([426491f](https://github.com/q0wqex/zashboard/commit/426491f55ac6a37366a29b10a01b49bad2ac3460))
* blur intensity ([cc73668](https://github.com/q0wqex/zashboard/commit/cc73668889d18f177065406b9633329c76edba1f))
* blurry effect ([8398a43](https://github.com/q0wqex/zashboard/commit/8398a435bfffb8aaaaac22423fb33dc6e76378ad))
* bouncein animation for mobile ([a1e9d38](https://github.com/q0wqex/zashboard/commit/a1e9d38b3f98d28ee0a100635e5c4e79aa0c660f))
* build with only one font ([fcb5592](https://github.com/q0wqex/zashboard/commit/fcb559216fa6ef517bb9fbf3dc6c0f04d5060ed3))
* channel selector for core upgrade ([b181dd1](https://github.com/q0wqex/zashboard/commit/b181dd1aeef80fbb2c9f648477afce3ed06b1886))
* check update for `mihomo_smart`'s fork ([#461](https://github.com/q0wqex/zashboard/issues/461)) ([0a48f44](https://github.com/q0wqex/zashboard/commit/0a48f4411c81ee742434907d66ee664497df67d4))
* city location for connection details ([44eb86d](https://github.com/q0wqex/zashboard/commit/44eb86d11f24afc1a5eca138b0688cca7a4078f0))
* collapsible sliders for opacity and blur ([5d88196](https://github.com/q0wqex/zashboard/commit/5d881964ce0c952ab9e2299139cb876573703305))
* **connections:** add additional metadata fields to search connections ([3df4b58](https://github.com/q0wqex/zashboard/commit/3df4b5893742d6e60de7e03f1ac79f26b9e39644))
* **connections:** Add auto-toggle display type for connections page ([184ed82](https://github.com/q0wqex/zashboard/commit/184ed823d3014445f8e524aa1aeaf47514ad32c0))
* **connections:** add source IP editing functionality in connection details ([132970d](https://github.com/q0wqex/zashboard/commit/132970daa3d44757d9eccb8521005b4704f6037a))
* **ConnectionTable:** add no data message to ConnectionTable component ([925980c](https://github.com/q0wqex/zashboard/commit/925980c8c94376336c5e31d28d71b2d07abd5240))
* **controls:** update sorting icons in ConnectionCtrl with new design ([1191b70](https://github.com/q0wqex/zashboard/commit/1191b701b3b8a2ab793a231923ee4a8bdd8c60e1))
* copy table content with right click ([c932df2](https://github.com/q0wqex/zashboard/commit/c932df2f2a17ba8a74afec59c320244f8ccc78dc))
* custom global node for sing-box ([9ead3bd](https://github.com/q0wqex/zashboard/commit/9ead3bdb3fcac40f0c1c0abc6238853ba958560b))
* custom icon for sing-box ([6db29e2](https://github.com/q0wqex/zashboard/commit/6db29e2b7a2cc885a3ae67fd301bf18df1922996))
* customizable min card width ([2958beb](https://github.com/q0wqex/zashboard/commit/2958beb7c3b5b6e20ddb4d9af00312978a9d0283))
* daisyui v5 & tailwindcss v4 ([9df2083](https://github.com/q0wqex/zashboard/commit/9df2083da99dc5baf008edc36f49d68c9c89171e))
* daisyuiv5-theme ([eec8209](https://github.com/q0wqex/zashboard/commit/eec8209f23f6dab9ab1247d66286870bb9604052))
* display all features setting for sing-box fork ([f309a89](https://github.com/q0wqex/zashboard/commit/f309a89d193556f01663782b2ca8772390b8a6bf))
* display final outbound in proxy group ([e974d50](https://github.com/q0wqex/zashboard/commit/e974d50f7cd8a0bacb404ca9a0de01087cbd1d77))
* display icon in connection details ([182b51f](https://github.com/q0wqex/zashboard/commit/182b51f1266ae945d058795d1a8a5aa52336aba7))
* display proxies grouped by provider ([5207e76](https://github.com/q0wqex/zashboard/commit/5207e76aee03773bf43099070de1c418a0cf6055))
* display URL in latency test result ([789bfed](https://github.com/q0wqex/zashboard/commit/789bfed4814f56ae74ef75f55aaa424c120349c4))
* download logs ([16fc9ee](https://github.com/q0wqex/zashboard/commit/16fc9ee86685a472835e01d9d6108cf6c3a243d9))
* drag the table with left mouse button ([4832487](https://github.com/q0wqex/zashboard/commit/4832487886beecf412c3f4a243483a9661080a75))
* draggable & editable source ip label ([36d19a9](https://github.com/q0wqex/zashboard/commit/36d19a9aff9f9df6a53039fce3d408fb3a5420db))
* effective scope for source ip label ([672df69](https://github.com/q0wqex/zashboard/commit/672df6996c90926b5c04ac69a6c016257cccf34e))
* enhance backend settings UI and add BackendPortsGrid component ([4eeb05d](https://github.com/q0wqex/zashboard/commit/4eeb05d5b7a33c17bca1027adef077aa9a82b4c1))
* enhance ConnectionHistory component with aggregation options and clear history functionality inspired by metacubexd ([b052b83](https://github.com/q0wqex/zashboard/commit/b052b83c8757d3e3cc6c08629cee3f2f9a2c7cba))
* enhance ProxyName component to display dialer proxy information dynamically ([d4faa97](https://github.com/q0wqex/zashboard/commit/d4faa97ba1879a564917b8d7f43b22ad1e5653e1))
* enhance rule management with mihomo API for toggling rule disable status and display rule hit/miss statistics in RuleCard component ([d93ae9b](https://github.com/q0wqex/zashboard/commit/d93ae9bfd363718be2f93483ad00fcc33aac1394))
* enhance settings components with improved dialog handling and grid layout ([4711084](https://github.com/q0wqex/zashboard/commit/4711084d26646a1990d6d4bceb271ac70fe4c223))
* enhance settings UI by restructuring components for better layout and styling; implement consistent setting item design across various settings pages ([081141e](https://github.com/q0wqex/zashboard/commit/081141eb9a5b1921304e9b2bf58c552468895b66))
* enhance settings UI with improved layout and new components ([761ae3f](https://github.com/q0wqex/zashboard/commit/761ae3f5bffe3e3b75bbd68c5b139e3ae31f18d5))
* enhance sourceip helper to support CIDR notation for IP addresses ([14fd233](https://github.com/q0wqex/zashboard/commit/14fd2334447119aa7d5816b613983c444c5b7308))
* flush dns cache ([81e67ab](https://github.com/q0wqex/zashboard/commit/81e67abe19f3296f91e420674aa03d83a342b380))
* flush dns cache for sing-box ([acdee6f](https://github.com/q0wqex/zashboard/commit/acdee6f4eb587cb4f66a802588f757ee58cb6806))
* force ProxyGroup open when rule proxy chain is expanded ([789d080](https://github.com/q0wqex/zashboard/commit/789d0803d673f989f552d3df8c2f6b088b552334))
* hover tip for latency history ([4814e90](https://github.com/q0wqex/zashboard/commit/4814e905c8c05280513cc7bf9f815d62731ab670))
* hover tip for proxygroup now node ([fb3b58e](https://github.com/q0wqex/zashboard/commit/fb3b58eaa80e2f201323ae9d4149cf99be33cb29))
* implement disconnect option on rule disable in RuleCard and update translations ([0476333](https://github.com/q0wqex/zashboard/commit/04763334be4b6a264a7a870c4b97072d641a967c))
* implement persistent settings store with legacy configuration migration logic ([bcd916f](https://github.com/q0wqex/zashboard/commit/bcd916f0fc0aaadfde1763cc9afc86b9c3fa184e))
* implement touchend event handling for mobile charts and improve chart disposal logic ([b099a2a](https://github.com/q0wqex/zashboard/commit/b099a2aa2ecf34189d2c91b820f8f8d1a1ad519c))
* implement visibility checks for settings items across multiple components; enhance user experience by conditionally rendering UI elements based on visibility state ([bb6990e](https://github.com/q0wqex/zashboard/commit/bb6990e8c7b1c2c2cb9cdc1bd963edc011a9326d))
* implement visibility control for settings items across multiple components; enhance user experience by conditionally rendering settings based on hiddenSettingsItems ([0509244](https://github.com/q0wqex/zashboard/commit/050924475d7b3a94424d4cb7e43ee7ce82f98979))
* import settings from url ([a67a337](https://github.com/q0wqex/zashboard/commit/a67a33718b51217e86eeef4b819af573a7a973f6))
* import settings with auto update ([2935456](https://github.com/q0wqex/zashboard/commit/2935456f8dbba9d192543e3255d2dfdb08071ac4))
* improve modal structure and accessibility; add transition effects ([cb358ef](https://github.com/q0wqex/zashboard/commit/cb358efd078a3bc125d57c0cc34fe0ce3f73d07c))
* improve settings page scroll tracking and relocate refresh button ([7eaebee](https://github.com/q0wqex/zashboard/commit/7eaebeed0f3d673a132096b5dc92040788551d2e))
* improve slide transitions with iOS-style animation ([eb7d932](https://github.com/q0wqex/zashboard/commit/eb7d932a163371e18e6d8d90d47de213d2b5487b))
* inbound user column ([7db4d1b](https://github.com/q0wqex/zashboard/commit/7db4d1bbdd23c043e5b8cd9f503a96239053667e))
* interrupt connection when switching clash_mode ([3921572](https://github.com/q0wqex/zashboard/commit/3921572103aa1c6918cff94e59fbed8dbc4916a4))
* latency test result tip ([02e4628](https://github.com/q0wqex/zashboard/commit/02e462841835d7efddf4a58483401c328e4c1079))
* link to backend github ([ae6a3e0](https://github.com/q0wqex/zashboard/commit/ae6a3e05e97acabc6f61f751775ce85ceee6a594))
* log card style ([ecaaea7](https://github.com/q0wqex/zashboard/commit/ecaaea7a33af5f489198af74347da61b6b2b2029))
* log search history ([091afd4](https://github.com/q0wqex/zashboard/commit/091afd4ea81782d490458ccaf56880bd1d7a0812))
* make backend editable ([1bc72de](https://github.com/q0wqex/zashboard/commit/1bc72deaa9e47589970a56ceb5e4d55775015198))
* make logs history deletable ([efe4bdb](https://github.com/q0wqex/zashboard/commit/efe4bdb47b8ce98543fe0845f8987e324d9147f2))
* move card/table customization to connections popup ([e372da1](https://github.com/q0wqex/zashboard/commit/e372da1ed60cd2c2e85fa93b0ccc54cd4da2312d))
* new animation for proxy group mobile ([e06225e](https://github.com/q0wqex/zashboard/commit/e06225ed9065e883ef64bdb6ddbe2d333cab1402))
* new looking for sidebar ([934d949](https://github.com/q0wqex/zashboard/commit/934d94942d797c81317bccec21804305ba5b7ded))
* notification for upgrade result ([a5adac3](https://github.com/q0wqex/zashboard/commit/a5adac3be271598db4baf85f39f4dc98855650c8))
* options for display global in non global mode ([9f2ca36](https://github.com/q0wqex/zashboard/commit/9f2ca36569ced463957c9e8f5493af5aae475501))
* options for geoip api ([ef693c8](https://github.com/q0wqex/zashboard/commit/ef693c821686b9d56194787bf9fd0d36b4f0b443))
* outbound column ([715481c](https://github.com/q0wqex/zashboard/commit/715481c18b4dcf181e483d494f4f52cf803bd2cf))
* pinnable columns ([abd8184](https://github.com/q0wqex/zashboard/commit/abd8184707c153533fbd2619a60a51721ff2009c))
* policy fixed now tip ([f1fab79](https://github.com/q0wqex/zashboard/commit/f1fab79c191a727bb1e134ffa6795827299cefd3))
* preset for connection card style ([539e23c](https://github.com/q0wqex/zashboard/commit/539e23c968d5384f7fb7d8027fb91ae6580875b8))
* **providers:** redesign ProxyProvider and RuleProvider with Apple-style aesthetics ([5d7035b](https://github.com/q0wqex/zashboard/commit/5d7035bb794dfc4614528710b562e73369c4241f))
* proxies relationship chart ([3e19df3](https://github.com/q0wqex/zashboard/commit/3e19df3c691d8f168f306a5acbfc4bdb50fc17c7))
* **proxies:** add option to disable text selection on proxies page ([#631](https://github.com/q0wqex/zashboard/issues/631)) ([2db4168](https://github.com/q0wqex/zashboard/commit/2db4168e70712ef26ca3abe3222ff27600b62f11))
* redesign settings layout and icon settings with drag-drop upload ([7c914d2](https://github.com/q0wqex/zashboard/commit/7c914d2ada8a6231052171b2d7edea1c8710a4c5))
* redesign zashboard@3 themes around the new Apple-inspired design language ([79f12bb](https://github.com/q0wqex/zashboard/commit/79f12bbcbeae2d4d98d69e721a9c05a38a9f7277))
* reF1nd sing-box ([16c4f47](https://github.com/q0wqex/zashboard/commit/16c4f47ba6a19d7196c4774d96c4de4917adedce))
* refactor OverviewPage to dynamically render cards based on visibility settings ([251fe79](https://github.com/q0wqex/zashboard/commit/251fe79bed055c8effec94b5cb923bdc9576e642))
* refine card layout with scroller-group system and proxy chain redesign ([6dfad29](https://github.com/q0wqex/zashboard/commit/6dfad29a1ec68b730079faf994bcc2057ddf0987))
* refine overview charts with MiniSparkline and improved axis labels ([ca22d39](https://github.com/q0wqex/zashboard/commit/ca22d398578256d0e16b4a4c1d928ec833bd83c7))
* refine UI components with macOS-style design improvements ([a9a93a6](https://github.com/q0wqex/zashboard/commit/a9a93a63d60cbd3b014b2afa3ffe32e6aaba4610))
* refresh btn for pwa ([791a287](https://github.com/q0wqex/zashboard/commit/791a28780cc2c2f812de7e5053cf8c143d05e858))
* remove ProxiesCharts component and update to TopologyCharts ([724f444](https://github.com/q0wqex/zashboard/commit/724f4443f06fa41f50f33fe59ea49d5d2b3d9a45))
* reorganize settings layout and consolidate panel style section ([349c0b3](https://github.com/q0wqex/zashboard/commit/349c0b328a7ab5800e0fcc6e76030b3093a4e90b))
* rule card style ([b0a421f](https://github.com/q0wqex/zashboard/commit/b0a421f867512fbadc60eed3aaa12d326375b4cb))
* search log with type selector ([8741f2c](https://github.com/q0wqex/zashboard/commit/8741f2cfa59692b564e4851e8c1c12233fea6b24))
* select proxy node in connections and rules ([acd1cd2](https://github.com/q0wqex/zashboard/commit/acd1cd286d71c9bf67f34c91fb70069e9901a422))
* setting for auto theme ([1aabb78](https://github.com/q0wqex/zashboard/commit/1aabb784e07ce050f77c4cd3a970e716455b525f))
* setting for number of charts in sidebar ([0f61f4d](https://github.com/q0wqex/zashboard/commit/0f61f4da39a57600cd978a40bd1462810120395e))
* **settings:** implement background settings component with theme detection ([482f8d0](https://github.com/q0wqex/zashboard/commit/482f8d0a1308f4c03511f7238962c6b159d6f684))
* shortcut key for router switch ([f246d36](https://github.com/q0wqex/zashboard/commit/f246d3620fcb2e3fe359a0f53af9e4769bb18c01))
* **shortcuts:** add backend switch shortcuts ([52f3686](https://github.com/q0wqex/zashboard/commit/52f3686c2eaceb47219f3ba5d70cfc0e2aaee309))
* **shortcuts:** add configurable keyboard shortcuts ([c467b4f](https://github.com/q0wqex/zashboard/commit/c467b4f5fd60a3a13a13149f5a4a5ff1f5a3f7d7))
* **sidebar:** simplify statistics structure and improve readability ([0f04fb6](https://github.com/q0wqex/zashboard/commit/0f04fb6392c4d95101831057c5e5f2a756b431ad))
* simplify SettingsPage layout by replacing inline menu with a dedicated SettingsMenu component; enhance scroll behavior for menu item navigation ([7793ee2](https://github.com/q0wqex/zashboard/commit/7793ee2910ecffbb5b4095d4424f3dd6e8885ee8))
* smart group api ([55510ae](https://github.com/q0wqex/zashboard/commit/55510ae801a458cd933dae63b332c0826d78845d))
* smart group sort by usage ([116f01d](https://github.com/q0wqex/zashboard/commit/116f01dda993fe5dc19bb84506ef76041936cf03))
* store scroll status for proxies page ([0522c68](https://github.com/q0wqex/zashboard/commit/0522c68ca0eed7ae47745e5deb6bd5c3980c1f29))
* style for proxy group ([b1de8f6](https://github.com/q0wqex/zashboard/commit/b1de8f68eece3d767f66af577516e778c1141a62))
* support all sing-box log level ([864997c](https://github.com/q0wqex/zashboard/commit/864997c21efd1f14c8abe3cd76247529f0c4cb7c))
* support multiple keywords in search ([19f3eb5](https://github.com/q0wqex/zashboard/commit/19f3eb590f5b1055bd854baa9bc9c079c2621625))
* switch for core upgrade check ([5ceaa73](https://github.com/q0wqex/zashboard/commit/5ceaa737bc51d052d71a883ed4db56124d3e76a3))
* switch for display now node & latency number in rule ([5a24958](https://github.com/q0wqex/zashboard/commit/5a24958d18258136abe8af33e7870ae23ba1a9af))
* switch for scroll animation ([1d9062b](https://github.com/q0wqex/zashboard/commit/1d9062b60274e09a4afd350eddbdbe9155f4c477))
* switch for swipe in pages ([6833d5e](https://github.com/q0wqex/zashboard/commit/6833d5e76bd043b30f3ecafb997f28b8c583d8e5))
* theme selector with preview ([e8a4335](https://github.com/q0wqex/zashboard/commit/e8a4335bdf2c3e85b3378d2b8a64c98d25884220))
* transfer type for connection table ([28f59c3](https://github.com/q0wqex/zashboard/commit/28f59c3c8006054c9d40b29b96ee29f5e8b2ff12))
* two-columns groups for mobile inspired by Clash Dash and Surge ([9e9fc5f](https://github.com/q0wqex/zashboard/commit/9e9fc5f5d954d9b70055b99c23f03fde134263f5))
* update rule provider in rules ([1a9605c](https://github.com/q0wqex/zashboard/commit/1a9605c89d4c99e67cff76e460ab9118b862e385))
* url params disable upgrade core ([cfca43c](https://github.com/q0wqex/zashboard/commit/cfca43c3fd58a183fc58f595560cc317273735a7))
* usage desc in proxy card for smart group ([8f1b370](https://github.com/q0wqex/zashboard/commit/8f1b37009222c083ba63c30cda7c72ef13928671))
* use twemoji for apple device ([5a7a6ff](https://github.com/q0wqex/zashboard/commit/5a7a6ff804fb0f5ff8c6f4da452db94b8beb6971))
* using the existing theme to reset custom theme ([daadc8f](https://github.com/q0wqex/zashboard/commit/daadc8f6ba43cf66841aff80280bd42a447633e3))


### Bug Fixes

* 0 in memory ws ([870dc0f](https://github.com/q0wqex/zashboard/commit/870dc0f127b4a8047f8e31a0ad33dbfb6b2c0666))
* abnormal scrolling when expanding proxy groups ([d865be9](https://github.com/q0wqex/zashboard/commit/d865be9e50e830816ddf9ece3c87f7538471f560))
* add default test turl ([be21958](https://github.com/q0wqex/zashboard/commit/be21958e53024ee53996a3aa9e19593208041a21))
* add key for proxy chains ([c2ec9b6](https://github.com/q0wqex/zashboard/commit/c2ec9b66f91e4576ede113f00277911c0a5411bf))
* add p-limiter for latency test ([7c656e8](https://github.com/q0wqex/zashboard/commit/7c656e8bc0e5e21011ca40c97a297d536640e142))
* add replace option to router push for consistent navigation behavior when running in mobile browser or in webui app like ksu ([#601](https://github.com/q0wqex/zashboard/issues/601)) ([8307db4](https://github.com/q0wqex/zashboard/commit/8307db4e5048345ecf391e98fd52b34c5b90c9e2))
* add settings-menu and ctrls-bar styles in main.css; update SettingsMenu.vue class for improved styling and functionality ([ec00509](https://github.com/q0wqex/zashboard/commit/ec00509bd0fca0ae35736dbbdfb3c977f04a0560))
* add timestamp for geoip api ([82258a9](https://github.com/q0wqex/zashboard/commit/82258a9432bc22d2b2cccbdde50abde73545b60a))
* add tip for mmdb file size ([e71aa4c](https://github.com/q0wqex/zashboard/commit/e71aa4c49ff93ffb5ab34917d6010b4c6c46bbec))
* adjust setting item height in main.css; conditionally render OverviewCard in OverviewSettings.vue; improve scroll behavior logic in SettingsPage.vue ([d68c581](https://github.com/q0wqex/zashboard/commit/d68c58180797531842b1c3570eebd61ae9235189))
* adjust styling for ProxyIcon and ProxyNodeCard components for better alignment ([d14e6ff](https://github.com/q0wqex/zashboard/commit/d14e6ff226a4c7b596b83bbe9e6662196424d9f9))
* animation and performance for two-column ([1e38efc](https://github.com/q0wqex/zashboard/commit/1e38efc5ebe7af0672aea8e3a205d2aa34794673))
* animation for swipe page ([f25078c](https://github.com/q0wqex/zashboard/commit/f25078cad670cc4dcae709a8fe095d79722768c1))
* animation performance for proxy group mobile ([8547702](https://github.com/q0wqex/zashboard/commit/85477025fa372705b7360567f585dc08e87f3f43))
* animation performance for proxy group mobile ([d80c8b0](https://github.com/q0wqex/zashboard/commit/d80c8b086116df94ffbcc47e4a1ba156515900fd))
* **api:** decode URL in error notification for better readability ([a66cb4c](https://github.com/q0wqex/zashboard/commit/a66cb4c8e4dfe4af3e3c7e35459a27341506742b))
* asn name -&gt; org name ([337f2c4](https://github.com/q0wqex/zashboard/commit/337f2c48c2e0520e93d3e1a5e7f834926c931ca2))
* auto scroll into view for mobile ([c5e701c](https://github.com/q0wqex/zashboard/commit/c5e701cd970903b290f97ca93c6ecdbd56e2d64c))
* backend api buttons grid style ([375ab8e](https://github.com/q0wqex/zashboard/commit/375ab8ee8ca1745d9a40cf7c035bcdf701c1a187))
* backend available detect ([0d8db22](https://github.com/q0wqex/zashboard/commit/0d8db2271bef2aa1da0a4c0a5481c1ac31c5c3ec))
* block error tip for latency test ([a84c608](https://github.com/q0wqex/zashboard/commit/a84c60846d221632cb3a206f7d2e5796894415cc))
* blur bg style for pinned columns ([3f4f8ec](https://github.com/q0wqex/zashboard/commit/3f4f8ec4603c3a15767d22e76a354e20b89eee08))
* blur effect for rules and logs page ([cea23ab](https://github.com/q0wqex/zashboard/commit/cea23ab6f06d194a9b8bf37d12a580e9fb2cc538))
* border radius styling of connnection table ([dd8d1d9](https://github.com/q0wqex/zashboard/commit/dd8d1d961f1a8026421b69a1776f326d62cbfeb3))
* bounce animation flicker ([7ceafb9](https://github.com/q0wqex/zashboard/commit/7ceafb91cf0ae1f433c22abfc9d25f465bbacb8a))
* bring old default theme back ([ecd0a5b](https://github.com/q0wqex/zashboard/commit/ecd0a5b30af7ac3240c86b742fa7a970f553988a))
* bring old v4 light and dark theme back to v5 ([d73484a](https://github.com/q0wqex/zashboard/commit/d73484a84d2e429857e4eb899fe479c78e1a4f4c))
* **btn:** primary btn style with background ([59324be](https://github.com/q0wqex/zashboard/commit/59324bef543ada3cfd478a011459e0993e3d5518))
* build release ([f6abc58](https://github.com/q0wqex/zashboard/commit/f6abc58be3dc603692c4c426a849b7746f23fab0))
* cache for github api ([51c6926](https://github.com/q0wqex/zashboard/commit/51c692656405065d6e18a8b6c35cf3fe8a1c0daf))
* cache github version check result ([b9f9864](https://github.com/q0wqex/zashboard/commit/b9f9864594e9306874a060c026259eef155f09d6))
* card customize style ([3cb1e84](https://github.com/q0wqex/zashboard/commit/3cb1e84bced195d370e049a64e3aed3a188ff4bf))
* card/table customize style ([8d3a382](https://github.com/q0wqex/zashboard/commit/8d3a382d6a10f9d21b08f8c176cba1145d905527))
* case insensitive search for connections ([771119a](https://github.com/q0wqex/zashboard/commit/771119a9fde71b97dccd7f096a75592201b1169e))
* catch icon settings empty ([1e95227](https://github.com/q0wqex/zashboard/commit/1e95227f34c3b076db09c310a3d7b6e210d5b071))
* catch testurl is empty ([a40c7e3](https://github.com/q0wqex/zashboard/commit/a40c7e312d5d9e1ca7a2e9d32ad1a5e870e75578))
* chart performance ([ca7b861](https://github.com/q0wqex/zashboard/commit/ca7b861fea8e03fc8d9ba94863d561fb1dd52c8c))
* chart style in sidebar ([88e4b17](https://github.com/q0wqex/zashboard/commit/88e4b176cd28d636a542d2dda820396638ee00c5))
* clash mode selector style for latest Chrome ([644e352](https://github.com/q0wqex/zashboard/commit/644e352651bf8f04281ffe96d0a91149f747309c))
* click on the backend  version will redirect you to an incorrect repository link when the backend is `mihomo_smart` ([#594](https://github.com/q0wqex/zashboard/issues/594)) ([b0c4872](https://github.com/q0wqex/zashboard/commit/b0c487280f91021a7e75b2f8dc3bab9a34b09669))
* collapse animation ([8453456](https://github.com/q0wqex/zashboard/commit/8453456412e7af5e2378fc6e0a027656844dfc13))
* collapse animation performance ([9c72e96](https://github.com/q0wqex/zashboard/commit/9c72e961725a15196188edb3731c8c48d6944237))
* collapse style with opacity ([78eefe3](https://github.com/q0wqex/zashboard/commit/78eefe39a862acbef852c2a47420d7edf3cbcfa0))
* connection & proxies ctrl style for iPad ([9c02345](https://github.com/q0wqex/zashboard/commit/9c023451662e1922de4d7f0128a338c694cabda8))
* connection card style ([717108f](https://github.com/q0wqex/zashboard/commit/717108fdd48e9bbe563614c2d1e474a1bd1b2bc3))
* connection details style ([acbcfb2](https://github.com/q0wqex/zashboard/commit/acbcfb2e2c22460c00147d73be610b539e988670))
* **ConnectionDetails:** improve layout and styling for better responsiveness ([544f096](https://github.com/q0wqex/zashboard/commit/544f0967bf1b18c7a04eda946dd8ee2b36c08df8))
* connections details modal ([de18946](https://github.com/q0wqex/zashboard/commit/de189463ac2359e7260ad3fc5d90dde90b6e6b42))
* control bar loses focus when the search result is empty ([32c8ca0](https://github.com/q0wqex/zashboard/commit/32c8ca043b34e9ff122f84b583ed004136e01c17))
* copy value for proxy chains column ([1ab23bf](https://github.com/q0wqex/zashboard/commit/1ab23bf0fe45ff76d27688d140d23d80d1a91847))
* default testurl with https ([a1eb0a4](https://github.com/q0wqex/zashboard/commit/a1eb0a41f2a63ee2ca469467609033b91bd5eeb8))
* delete fixed for smart group ([5bcbd2b](https://github.com/q0wqex/zashboard/commit/5bcbd2b31819e721a10f76a357e8e881ab59498a))
* dialog style ([616cecb](https://github.com/q0wqex/zashboard/commit/616cecb25386407f41fc0f16269c77c60a31c7ab))
* **DialogWrapper:** add Enter key event support and optimized focus management ([#599](https://github.com/q0wqex/zashboard/issues/599)) ([f228d21](https://github.com/q0wqex/zashboard/commit/f228d2124807514238247f7f8953500bef34c4b8))
* **DialogWrapper:** remove default focus outline on modal box ([cd280da](https://github.com/q0wqex/zashboard/commit/cd280dad817dec8f71bb76aade0cd6cab633c29d))
* disable proxy select for loadbalance ([e37f83e](https://github.com/q0wqex/zashboard/commit/e37f83e1e12fd6a5ce984a55bb2076c585579306))
* disable swipe when input focused ([6426052](https://github.com/q0wqex/zashboard/commit/6426052a9be131a0c032fd8a699160e168002539))
* discard outdated latency result ([97cce60](https://github.com/q0wqex/zashboard/commit/97cce608067b038db05f7c418b9410b29f160d99))
* display backend label instead of url ([6cc3469](https://github.com/q0wqex/zashboard/commit/6cc3469e2b3eda6f064f2fa49e408da4f90facef))
* display issue of the popover for sourceip scope ([6db326e](https://github.com/q0wqex/zashboard/commit/6db326e2d2c89333e1aa261bdb6703042562c34d))
* display now node for smart ([856a4a6](https://github.com/q0wqex/zashboard/commit/856a4a6cc8f7b410a25741453b5c99c274088964))
* Dockerfile ([f604811](https://github.com/q0wqex/zashboard/commit/f604811801a8573a9f95faa38732304a750f7391))
* drag behavier ([3fdfd73](https://github.com/q0wqex/zashboard/commit/3fdfd73b4b160a63d61b88a20a64873fa37f20de))
* drag for thead resize handler ([bdea376](https://github.com/q0wqex/zashboard/commit/bdea3765252f86997a12914fd1789d7b4ba6bfbb))
* dropdown position for safari ([51ca0a4](https://github.com/q0wqex/zashboard/commit/51ca0a4f42a7e9e8a86186e767b3a6117390795c))
* duplicate theme selector ([b76f9b7](https://github.com/q0wqex/zashboard/commit/b76f9b75b87ef487fd5015136c45bbcdb5522a6a))
* enhance styling and structure of menu items in TextInput component for improved user experience ([21c6a82](https://github.com/q0wqex/zashboard/commit/21c6a829240c7393a3e93a1dacb3e01ce711bcb0))
* enhance TopologyCharts component by implementing node sorting and ID remapping for improved data visualization ([4873bf3](https://github.com/q0wqex/zashboard/commit/4873bf311d3900c150d0ad256ec476121769391c))
* ensure dbPromise is awaited in put, clear, and del functions of useIndexedDB for proper transaction handling ([b194dfd](https://github.com/q0wqex/zashboard/commit/b194dfd2c787cafa3b3d00be3dc2bf10803fdf86))
* final destination for direct connection ([0702d1a](https://github.com/q0wqex/zashboard/commit/0702d1afdb46b11ab0c4f31021d3570e3f19b0cc))
* flickering scrollbar ([7aaa6aa](https://github.com/q0wqex/zashboard/commit/7aaa6aa6c3bd20a479bb53f9f41fa7c7797c73f6))
* font name of system-ui ([#381](https://github.com/q0wqex/zashboard/issues/381)) ([f5a9db9](https://github.com/q0wqex/zashboard/commit/f5a9db98be666e7c66be6674d51d8b9ea7998a2b))
* force import settings ([e7ce551](https://github.com/q0wqex/zashboard/commit/e7ce55108ef952ff1eed637baf9a67575243af61))
* freezing issue when scroll animation is on ([e293832](https://github.com/q0wqex/zashboard/commit/e2938326b98b8ed9ffd62a66fb7121569df2f479))
* fullscreen mode for proxies chart with bg-image ([acac4b6](https://github.com/q0wqex/zashboard/commit/acac4b64596ee38483b7337228c2f12166cc6ebd))
* global for sing-box ([ae25805](https://github.com/q0wqex/zashboard/commit/ae25805370970a2faa82f9a7a65cb36ea6f21b5c))
* grid style ([677abad](https://github.com/q0wqex/zashboard/commit/677abad58014930d6cadbc68316dd6a861158018))
* grouped connection table style ([3f4e082](https://github.com/q0wqex/zashboard/commit/3f4e0828ef68fe8b4369c43175224b712d7d8f87))
* hidden group icon status ([89d459a](https://github.com/q0wqex/zashboard/commit/89d459ab56c718de2d0cc3440bf71c13493abaaf))
* hide toggle collapse btn ([3f3bc03](https://github.com/q0wqex/zashboard/commit/3f3bc03394925005abbc9e3f9101c172f00ee7aa))
* highlight text for dark theme ([902af5c](https://github.com/q0wqex/zashboard/commit/902af5cff064d9f3b29329383be43b48f1d6d089))
* i18n ([37e3a01](https://github.com/q0wqex/zashboard/commit/37e3a01fa7113fe92149ca60919966af7cbd5a13))
* i18n for remote destination ([788fef0](https://github.com/q0wqex/zashboard/commit/788fef0fa8c0a979c4d290032a2c507826868474))
* **i18n:** missing i18n for smart core ([64e786d](https://github.com/q0wqex/zashboard/commit/64e786de453b514a8635a72806d5ef37c7454594))
* icon cache by browser ([b459108](https://github.com/q0wqex/zashboard/commit/b459108dae76e5329ed8b0cc8031250257e68fc2))
* icon settings collapse style ([7a17311](https://github.com/q0wqex/zashboard/commit/7a173114da06fe31a7df25a0c1049c308b7b19c7))
* icon size settings ([95dc3a5](https://github.com/q0wqex/zashboard/commit/95dc3a51d566f7189c5804a2d8d72e1bb4b43ff0))
* implement dynamic favicon switching based on color scheme preference for firfox ([005ff49](https://github.com/q0wqex/zashboard/commit/005ff49a315db6e3668ee4a13d11add78d2bb4ea))
* implement tooltip activation handling in TopologyCharts component to prevent data updates during tooltip visibility ([ccf3ee4](https://github.com/q0wqex/zashboard/commit/ccf3ee40ece01c512bc6dacc245b0e6605af80ad))
* import settings modal style ([48fa4f8](https://github.com/q0wqex/zashboard/commit/48fa4f8c6cba0ab5309be3a75cb7dfc9e6546ef5))
* improve DNS query and TextInput component ([42bde0a](https://github.com/q0wqex/zashboard/commit/42bde0ab8f974529e1f74795cacef0fb9b857897))
* improve getHostFromConnection function to handle different host scenarios and support IPv6 formatting ([33003b8](https://github.com/q0wqex/zashboard/commit/33003b851d980ce9becbbfe06c052745fa93257d))
* improve menu item interaction in TextInput component by adding overflow handling and refining delete functionality ([7010d41](https://github.com/q0wqex/zashboard/commit/7010d41cc1bd7d11e2f9a1820fc815819f6efbf7))
* improve node handling in Sankey chart to prevent incorrect loops and enhance link filtering ([900b277](https://github.com/q0wqex/zashboard/commit/900b2774bf0de5101c5cb1495e1677bd90b56f62))
* incorrect scrolling status when switching tabs in proxies ([c8c6eb6](https://github.com/q0wqex/zashboard/commit/c8c6eb62866ab62754639d32d01dc023da5581cc))
* increase swipe threshold in useSwipeRouter for improved gesture recognition ([de1f690](https://github.com/q0wqex/zashboard/commit/de1f6909b7bfafc4cc87382346694f944d29eab1))
* independent latency test for provider healthcheck ([9f26a5d](https://github.com/q0wqex/zashboard/commit/9f26a5defd581c18fb20fc828373d9dc57ec6b0b))
* input select style ([f20ed11](https://github.com/q0wqex/zashboard/commit/f20ed1186c2ce63f670bc0e42cff7d78751b063e))
* ip details when destinationIP is null ([3d1e4cd](https://github.com/q0wqex/zashboard/commit/3d1e4cdbdbbe6256265553d675156ab2d5f7a678))
* is private ip ([570aae9](https://github.com/q0wqex/zashboard/commit/570aae9be701c41abd8f107e54dba4ac41791b6b))
* isProxyGroup for smart ([48efc1f](https://github.com/q0wqex/zashboard/commit/48efc1fc2abf95a5b7eecec2de97d4ae5ec8d9b9))
* latency test result tip ([cd50643](https://github.com/q0wqex/zashboard/commit/cd50643d6743fa224c3ec6300a835d00f46548a1))
* latency tests for all will now follow the logic of the independent latency test. ([8ccd6f3](https://github.com/q0wqex/zashboard/commit/8ccd6f3d176b6bb9f69edff603d7460b86e9553a))
* lazy load for proxies ([80ef19c](https://github.com/q0wqex/zashboard/commit/80ef19c911dc8ad03f17e84b6566659f51040b2b))
* log & toast style ([d2be891](https://github.com/q0wqex/zashboard/commit/d2be891e07f3eda7460bf199883af2e8c7f841a7))
* long host style in connection table ([9428cc5](https://github.com/q0wqex/zashboard/commit/9428cc505d0d46200042b21e5164f56d58f449e2))
* long rule for sing-box in table ([164f98f](https://github.com/q0wqex/zashboard/commit/164f98ff6a54fec9a8e10563f72f496094bd26ce))
* **main:** prevent history state manipulation in Edge browser ([87799dd](https://github.com/q0wqex/zashboard/commit/87799dd9e9f3312c10d257f59f29909fabc2fdaf))
* make daisyui v5 theme as default ([e0bc078](https://github.com/q0wqex/zashboard/commit/e0bc07881ce62258534e40874513455864c6a987))
* make disable pull to refresh optional ([56e2273](https://github.com/q0wqex/zashboard/commit/56e2273da856510f95b95aba19b208798366183e))
* make table grouping state persistent ([017cbf9](https://github.com/q0wqex/zashboard/commit/017cbf9a69c7306e7add1b2b1f9a08dcb6530354))
* manage hidden groups and other minor style ([cde403e](https://github.com/q0wqex/zashboard/commit/cde403ec9e8ce6466bedb7b18c5d354f36111edc))
* merge same sourceip label options ([43a8576](https://github.com/q0wqex/zashboard/commit/43a8576eddab71f5c7590a166b9a84dc738bea1a))
* missing collapse all btn in mobile ([3e7ee22](https://github.com/q0wqex/zashboard/commit/3e7ee224f0646820f6f3635c37d8b05a95644457))
* missing lock icon for proxy group in mobile ([c66c846](https://github.com/q0wqex/zashboard/commit/c66c84635fbf1c379b97c15ab4a333fb54a2708d))
* missing proxies ctrl in some cases ([375a0d4](https://github.com/q0wqex/zashboard/commit/375a0d4e8b86c87ecb25481cbf8dbeae9cae68ee))
* missing sourceip filter when ip is invalid ([e5ff530](https://github.com/q0wqex/zashboard/commit/e5ff53080c30e6e7afcea0cc357a3fc964a2fe4a))
* modal opacity style ([5c56ddc](https://github.com/q0wqex/zashboard/commit/5c56ddc7f9184871deacdfa29814ca8bb94b04cc))
* notification style ([9da9272](https://github.com/q0wqex/zashboard/commit/9da927232cd0a73f260d52794fddf2a82179c618))
* notification style ([9ceeca4](https://github.com/q0wqex/zashboard/commit/9ceeca42c7fd1c7ea8dae68b9d2e908ff87362d7))
* optgroup bg with opacity ([4b57b0b](https://github.com/q0wqex/zashboard/commit/4b57b0b578cc0afa7b9642e843ea5f490d3d536d))
* options for proxies count ([e0e51af](https://github.com/q0wqex/zashboard/commit/e0e51af831a62933a2137b7e7230c78d91e2d4f1))
* outline style ([c840ab2](https://github.com/q0wqex/zashboard/commit/c840ab2d71ff8f4f118ac98dc7d00bff3b400e71))
* padding top style in 768px screen ([7031b8b](https://github.com/q0wqex/zashboard/commit/7031b8b6b0d3287d67fa6701983a4ba90d421c5f))
* performance for massive connections ([866ea1d](https://github.com/q0wqex/zashboard/commit/866ea1d46358b946b76a2aadeb4d28460878c01d))
* performance for massive connections ([a1de977](https://github.com/q0wqex/zashboard/commit/a1de977005eeae0e02e139ea466390fa9623b0a5))
* performance for page switch ([f25b5bc](https://github.com/q0wqex/zashboard/commit/f25b5bc12e46e4482da48597ad967ddbaa5293ee))
* placeholder for ip check failed ([e3a5aa3](https://github.com/q0wqex/zashboard/commit/e3a5aa3c46ded51219d2be9d6083903ecc73b2a5))
* placeholder for sourceip & icon ([bbbf52f](https://github.com/q0wqex/zashboard/commit/bbbf52fe295632dc18b612207f6176ff2c03f6af))
* popover position for theme selector ([9ea6f68](https://github.com/q0wqex/zashboard/commit/9ea6f6874b827751270311d5d51319d42e2ca71f))
* prevent selecting a selected node ([b7fd831](https://github.com/q0wqex/zashboard/commit/b7fd8316420574da51b591bfac55a5afc085f1aa))
* prevent TypeError when proxiesRef is null during scroll or waitTick ([#629](https://github.com/q0wqex/zashboard/issues/629)) ([4b0f0f1](https://github.com/q0wqex/zashboard/commit/4b0f0f144a9c69cdbb0c7dd69916f335d962ab20))
* promise race for automatic backend switch ([be8fecb](https://github.com/q0wqex/zashboard/commit/be8fecbc50643dd71919233914ae1b867d348379))
* provider style and count ([8a2eb32](https://github.com/q0wqex/zashboard/commit/8a2eb32ff73648d7a6537f5875344dcd7fc681e9))
* proxies page dual column style ([edda6f3](https://github.com/q0wqex/zashboard/commit/edda6f37b7f6a073452ffc8ea49542d351dc4829))
* proxies page performance ([b73f2ac](https://github.com/q0wqex/zashboard/commit/b73f2acdb298307af362c346eab3ffbb582ed0dd))
* proxies preview auto ([9c1f00b](https://github.com/q0wqex/zashboard/commit/9c1f00b9163ee44ba87bb054c7410da857d31237))
* proxies scroll style ([96389aa](https://github.com/q0wqex/zashboard/commit/96389aacdfbe055cd82e9678c0ca14199f2b6157))
* proxy chains sort ([851ebb9](https://github.com/q0wqex/zashboard/commit/851ebb9b8fec95063601936b76be537d7fca309e))
* proxy chains sort ([3415c3f](https://github.com/q0wqex/zashboard/commit/3415c3f89b29df6f2bdefca7e66e5aba8be482db))
* proxy group grid style ([460d426](https://github.com/q0wqex/zashboard/commit/460d426208f9873f48026ee1fed16447ea0822e5))
* proxy group invisible ([461aa0b](https://github.com/q0wqex/zashboard/commit/461aa0b1ea81b640ce7a174df31531ced4636999))
* proxy group sort by latency ([8ee9827](https://github.com/q0wqex/zashboard/commit/8ee9827030fce65530036dd44181e3673ff0b078))
* proxy provider style ([9eb400b](https://github.com/q0wqex/zashboard/commit/9eb400b19cfdf905c879616af8e78d2863823dfb))
* proxy provider style with two-columns ([1e2d07e](https://github.com/q0wqex/zashboard/commit/1e2d07ea943f2764e8d0f6c2a324cdb6cd7b9402))
* proxy sorting will no longer affect policy groups ([4467657](https://github.com/q0wqex/zashboard/commit/446765780a142025d4e3752b388e45b8b5310033))
* **proxy:** update display format for proxy group type and count ([1acc253](https://github.com/q0wqex/zashboard/commit/1acc253f8a08350e5578a7ed82f6364cb7a27bc6))
* **pwa:** load fonts and images from assets instead of public ([773e2d6](https://github.com/q0wqex/zashboard/commit/773e2d6f324f83ebb74bc54c8d9e3f3be9d439b2))
* region for details ([eaf8cf1](https://github.com/q0wqex/zashboard/commit/eaf8cf1127bafaa6dfa83d9d90f60ae972489e3c))
* remove close btn for closed conns ([23abefe](https://github.com/q0wqex/zashboard/commit/23abefe66de64723dc47026461b58596f73727df))
* remove CNAME in dist ([5e1c4d3](https://github.com/q0wqex/zashboard/commit/5e1c4d31884c56327f38fb91925d69d025e4be3c))
* remove deprecated details button ([b06492a](https://github.com/q0wqex/zashboard/commit/b06492af4b6ec28d403ccc001b0436140b420ec9))
* remove openai cdn test ([78bfe09](https://github.com/q0wqex/zashboard/commit/78bfe0945bb09fa9f9d5f30227b6e1a4c3fdda93))
* remove plimit for latency test ([5f8f70e](https://github.com/q0wqex/zashboard/commit/5f8f70e63e5cc558ce919f2e6115496a8c14ca97))
* remove redirect to setup when api 404 ([50ca346](https://github.com/q0wqex/zashboard/commit/50ca346b806491c12fa066ffca1bc75353a6310e))
* rule provider style ([f0dda31](https://github.com/q0wqex/zashboard/commit/f0dda319db40382c82527814803996fdc6343938))
* safe area for bottom ([72b3682](https://github.com/q0wqex/zashboard/commit/72b36821e32675850796564f2f23994fcf03cef4))
* scrollbar & proxy chains style ([16bdbc4](https://github.com/q0wqex/zashboard/commit/16bdbc438214bc00be65f57ce3dfd881a3e238b9))
* separate destination and proxy node IP column ([51a502e](https://github.com/q0wqex/zashboard/commit/51a502e942d63be1fab9fbb0b81c94714f97237c))
* set history after latency test ([cee66f8](https://github.com/q0wqex/zashboard/commit/cee66f8ecca239b388e1133e7bead2d9a9503785))
* setup page style ([5305893](https://github.com/q0wqex/zashboard/commit/5305893312e0a35f4c8d859df9146be97039a465))
* show hidden group -&gt; manage hidden group ([4e8fb42](https://github.com/q0wqex/zashboard/commit/4e8fb42977a1513ef4cb28b0cb09bafb7e04c6c6))
* **sidebar:** adjust collapse animation timing ([5b1aa2f](https://github.com/q0wqex/zashboard/commit/5b1aa2f597423a48538087c7ccb58405ceef4192))
* smart core weights fetch ([748272b](https://github.com/q0wqex/zashboard/commit/748272b082a2505ad4b37713a3e19f5893382593))
* smart weights display for mobile ([4183ece](https://github.com/q0wqex/zashboard/commit/4183ece9049114cfcf4c686c45e6833f56635128))
* some minor fix ([6f2edb6](https://github.com/q0wqex/zashboard/commit/6f2edb651f32bfcda05f341647650d9cc5dfda84))
* sort desc first for speeds ([f3030bc](https://github.com/q0wqex/zashboard/commit/f3030bcc567a12324cfdcfdc6b08b3c32d9603de))
* sort for proxy group not in GLOBAL ([27a6c5a](https://github.com/q0wqex/zashboard/commit/27a6c5a2e4d926362539a34e01aa67f8d5ae1a83))
* source ip input & backend version style ([441871c](https://github.com/q0wqex/zashboard/commit/441871cef532d52787273270e489cd3cf7d3d210))
* sourceip label scope style ([1cb4c56](https://github.com/q0wqex/zashboard/commit/1cb4c56f34fdb87716ce637d08baa0e925deddf9))
* sourceip options sort ([7907be0](https://github.com/q0wqex/zashboard/commit/7907be04d52433227d0ae5bde32c0a71ec44ec23))
* sourceip scope for logs ([16379ff](https://github.com/q0wqex/zashboard/commit/16379ffa423a99bd133672282b21d6dde8554d75))
* standardize capitalization in English localization strings ([89bdeeb](https://github.com/q0wqex/zashboard/commit/89bdeeb71834ed509fa6802121724aa635378325))
* **storage:** migrate legacy storage keys for selected node and connection card ([72d2b49](https://github.com/q0wqex/zashboard/commit/72d2b492fd2d7b8c59dea92581b415b47216c2d7))
* style ([193acc2](https://github.com/q0wqex/zashboard/commit/193acc23cfdb60722b4b16e1544f6c458d111518))
* style for connection details ([17d3504](https://github.com/q0wqex/zashboard/commit/17d3504eac86856d24cb8e7b3312c1d299d42f96))
* style for transparent ([6e54ac3](https://github.com/q0wqex/zashboard/commit/6e54ac322b6d8feb304ff370a003056c7e99ed39))
* style for vertical info ([82c390c](https://github.com/q0wqex/zashboard/commit/82c390c22a5bcab86b890802631aadec05a42e37))
* swipe animation performance ([9837522](https://github.com/q0wqex/zashboard/commit/98375229e1db1efb8d8047e2f592ca56950fee53))
* switch for display GLOBAL by mode ([60fc0c3](https://github.com/q0wqex/zashboard/commit/60fc0c33adb13d7fd0e1c18d6a320fd7d5a8a08b))
* tab style for mobile ([44c519b](https://github.com/q0wqex/zashboard/commit/44c519b103f37a9797a127eb00aa1b38541c97f3))
* **table:** correct translucent background styling ([c8f34cc](https://github.com/q0wqex/zashboard/commit/c8f34cc2f07c78500b58f2cec0aa4be3a199c0f0))
* timeout for notification ([2ecbb6b](https://github.com/q0wqex/zashboard/commit/2ecbb6bd40780266608c4cdc33ba1756ab44aeb8))
* tip for latency test failed ([47196a8](https://github.com/q0wqex/zashboard/commit/47196a80215e430d1f3cd2b242bf86d881f2b8db))
* tip position for import config ([6caf07c](https://github.com/q0wqex/zashboard/commit/6caf07cb3d230da0efcb62227f1453e8ea6e76ad))
* toast & settings style ([f33a077](https://github.com/q0wqex/zashboard/commit/f33a077e7386779ec438f59b55a2b0956b7e7635))
* total is 0 in subscription ([b45e17a](https://github.com/q0wqex/zashboard/commit/b45e17a30fad0a4afa8d72cdf028a0489fcb8115))
* translate for mode ([2660118](https://github.com/q0wqex/zashboard/commit/2660118f9103b802d6ec4051238974146eb8d040))
* truncate long version numbers ([534891b](https://github.com/q0wqex/zashboard/commit/534891bf7d3450713a23e847c78af12aad4f6b21))
* truncate name for proxy group mobile ([bf74766](https://github.com/q0wqex/zashboard/commit/bf74766dfa574640f78eeee6403439eb9fa2dc89))
* twemoji color on ios ([b533a17](https://github.com/q0wqex/zashboard/commit/b533a1757d6e7079f71a98390d45fc11cf8070f8))
* two columns style for md screen ([3561fdf](https://github.com/q0wqex/zashboard/commit/3561fdfb74a2a3ac43ab0fc99d2ed9695d7249aa))
* unable to disable blur in proxies for mobile ([bdbb9da](https://github.com/q0wqex/zashboard/commit/bdbb9da07fdf85c11f06ad4e40a79971a07a30f8))
* unexpected dual column for proxies provider ([ace7864](https://github.com/q0wqex/zashboard/commit/ace78646489a9ebf5c28abb6616e29acd64028c1))
* update destination and destinationType labels in multiple language files for clarity ([5add1d8](https://github.com/q0wqex/zashboard/commit/5add1d847963f3f7e095f520ba5b567da5967fbf))
* update ProxyNodeCard layout and text styling for improved readability and responsiveness ([dd59806](https://github.com/q0wqex/zashboard/commit/dd598062246e40ac975a901a08a24b80e2e600a6))
* update ProxyNodeGrid styling to ensure proper grid layout and responsiveness ([edb87c7](https://github.com/q0wqex/zashboard/commit/edb87c70ee64ed5fd00d85e100592b65620fbc4d))
* update regex handling in restructMatchs function to correctly match keys with and without colons ([528fcc8](https://github.com/q0wqex/zashboard/commit/528fcc8333a2bafa2328acf621bc72bc79610301))
* update row background color logic for improved styling consistency ([eb70c18](https://github.com/q0wqex/zashboard/commit/eb70c18240588b0a2ce30a7b5b6e53d559e7c612))
* update RuleCard component to enhance toggle functionality and adjust checkbox styling; modify HomePage dialog layout ([9e123fc](https://github.com/q0wqex/zashboard/commit/9e123fca102f88f707fb36e89141bfb8c90b7b9e))
* update styling for CollapseCard and ProxyNodeCard components to improve layout and hover effects ([485909e](https://github.com/q0wqex/zashboard/commit/485909e60f753b5e469dfedecff52e0bda49a6c8))
* url https params ([c53165a](https://github.com/q0wqex/zashboard/commit/c53165a3f1bf1695457a2970912da6513b5b6903))
* url will only be shown in independentLatencyTest mode ([fd28fd4](https://github.com/q0wqex/zashboard/commit/fd28fd4033445f515ec3793718e1ebeee85fc25b))
* xudp tag display ([c281d7c](https://github.com/q0wqex/zashboard/commit/c281d7c6736c01f90b31a56bd3cf0ced66bc8452))
